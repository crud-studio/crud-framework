...
public interface IndexHooks<ID extends Serializable, Entity extends BaseCrudEntity<ID>> extends CRUDHooks<ID, Entity> {
	 ...
	 * If {@link studio.crud.crudframework.crud.model.ReadCRUDRequestBuilder#fromCache} is used, this method will be skipped. It will be called  data access checks and run inside of a read-only transaction.
	 * @param filter the filter used in the operation
